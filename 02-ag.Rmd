...
\begin{figure*}
  \begin{center}
    \includegraphics[width=0.9\textwidth, height=3.7in,keepaspectratio]{figures/fe-1}
  \end{center}
...
\begin{suppfigure}[h]
  \begin{center}
    \includegraphics[width=0.85\textwidth, height=3.8in,keepaspectratio]{figures/cdl_vs_nlcd-1}
  \end{center}
...
\begin{suppfigure}[h]
  \begin{center}
    \includegraphics[width=0.45\textwidth, height=3in,keepaspectratio]{figures/tile_drainage_vs_clay-1}
  \end{center}
