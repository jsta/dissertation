...
\bottomrule
\end{tabular}
  \caption{Category definitions from the 2010 CDL. See code supplement for listing of variables classified as 'ag' (https://doi.org/10.5281/zenodo.3754916).} \label{tables2.1}
\end{supptable}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Lake trophic state in our study lakes versus all lakes from Soranno et al. (2017) located within our study extent. Trophic state based on the chlorophyll critera from Carlson (1996).}\label{figs2.3}
\end{suppfigure}
