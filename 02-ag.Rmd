...
\bottomrule
\end{tabular}
  \caption{Medians followed by first and third quantiles of predictor variables for 928 lakes. Also shown is whether each predictor is defined as an aggregate or granular measure of agriculture or as a non-agriculture (other) predictor. Dashed entries for the granularity category indicate an identical categorization as the preceding predictor.} \label{table1}
\end{table}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Example of increasing granularity for total Ag to Ag versus pasture, to pasture versus specific crops. For illustration, only corn, soybeans, and pasture are shown rather than all CDL land-use categories.}\label{figs1}
  \end{suppfigure}
...
\bottomrule
\end{tabular}
  \caption{Category definitions from the 2010 CDL. See code supplement for listing of variables classified as 'ag' (https://doi.org/10.5281/zenodo.3754916).} \label{chap:tables1}
\end{supptable}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Lake nutrient concentrations plotted against percent watershed agriculture.}\label{figs2}
\end{suppfigure}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Lake trophic state in our study lakes versus all lakes from Soranno et al. (2017) located within our study extent. Trophic state based on the chlorophyll critera from Carlson (1996).}\label{figs3}
\end{suppfigure}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Heatmap showing Pearson correlation coefficients among predictor variables. Grey cells denote correlation matrix diagonals.}\label{figs5}
\end{suppfigure}
...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Scatterplot showing the median clay content of watersheds in our hydrologic regions plotted against percent tile drainage from Nakagaki and Wieczorek (2016). The regions that are highly sensitive to agricultural land-use from Figure 4 are highlighted in red.}\label{figs6}
\end{suppfigure}
