...
\begin{suppfigure}[h]
  ...
  \end{center}
  \caption{Scatterplot showing the median clay content of watersheds in our hydrologic regions plotted against percent tile drainage from Nakagaki and Wieczorek (2016). The regions that are highly sensitive to agricultural land-use from Figure 4 are highlighted in red.}\label{figs2.6}
\end{suppfigure}
