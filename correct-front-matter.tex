...
\item \hangbibentry{stachelekAgriculturalLanduseLake2020}
...
\vspace{0.1em}
\noindent
In addition to the papers that make up my Dissertation, I was an author on numerous  papers that are not explicitly listed above but were instead precursors to dissertation chapters (Stachelek and Sorrano (2019) and Stachelek et al. (In prep) respectively):
\vspace{0.3em}
...
\item \hangbibentry{stachelekjosephLAGOSNEInterfaceLake2019}

\item \hangbibentry{stachelekjosephGssurgoPythonToolbox2019}
