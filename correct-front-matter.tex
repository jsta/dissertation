...
\vspace{0.1em}
\noindent
In addition to the papers that make up my Dissertation, I was an author on papers that are not explicitly listed above but were instead precursors to dissertation chapters:
\vspace{0.3em}
