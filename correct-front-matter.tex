...
\hangbibentry{stachelek_2019}

\hangbibentry{stachelekjosephAgriculturalLanduseLake2020}

\hangbibentry{stachelekjosephBathymetryDataThousands2020}

\vspace{0.5em}
\noindent
In addition to the papers that make up my dissertation, I was an author on numerous  papers that are not explicitly listed above. Two of these papers were precursors to dissertation chapters (Stachelek and Sorrano (2019) and Stachelek et al. (In prep) respectively).
\vspace{0.5em}

\hangbibentry{stachelek_national_2018}

\hangbibentry{hollisterLakemorphoCalculatingLake2017}
...
\hangbibentry{collinsWinterPrecipitationSummer2019}

\hangbibentry{mcculloughApplyingPatchmatrixModel2019}

\hangbibentry{mcculloughLakesFeelBurn2019a}

\hangbibentry{qianImplicationsSimpsonParadox2019}

\vspace{0.5em}
\noindent
My co-authored papers with the CNH Lakes project include:
\vspace{0.5em}

\hangbibentry{wardIntegratingFastSlow2018}

\hangbibentry{cobournConceptPracticePolicy2018}
